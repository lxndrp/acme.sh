...
See the [Docker Guide](https://github.com/acmesh-official/acme.sh/wiki/Run-acme.sh-in-docker) and [Docker Compose secrets documentation](https://docs.docker.com/compose/how-tos/use-secrets/) for more information.
